...
const EditDetails = () => {
  ...
  const fetchData = async () => {
    console.log(id);
    await axios
      .get(`${server}/single-details/${id}`)
      .then((res) => {
        console.log(res);
        setPara1(res.data.details.para1);
        setPara2(res.data.details.para2);
        setImage1(res.data.details.image1);
        setImage2(res.data.details.image2);
      })
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .patch(`${server}/update-details/${id}`, newForm, config)
      .then((res) => {
        setIsLoading(false);
                ...
                <img
                  ...
                  src={
                    image1 instanceof File
                      ...
                      : `https://reelman-back.onrender.com/uploads/${image1}`
                  }
                  alt="image"
                />
              ) : (
                ...
                <img
                  ...
                  src={
                    image2 instanceof File
                      ...
                      : `https://reelman-back.onrender.com/uploads/${image2}`
                  }
                  alt="image"
                />
              ) : (
